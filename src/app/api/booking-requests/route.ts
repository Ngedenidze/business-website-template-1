...
export async function POST(request: Request) {
  try {
    ...
    const created = await writeClient.create({
      ...
      selectedDeliveryDistance: payload.selectedDeliveryDistance,
      selectedSetupTent: payload.selectedSetupTent,
      estimatedPackagePrice: payload.estimatedPackagePrice,
      estimatedAddOnPrice: payload.estimatedAddOnPrice,
      estimatedDeliveryFee: payload.estimatedDeliveryFee,
      estimatedSetupFee: payload.estimatedSetupFee,
      estimatedTotal: payload.estimatedTotal,
      matchedServiceTown: payload.matchedServiceTown,
      matchedTownDistanceMiles: payload.matchedTownDistanceMiles,
      matchedDeliveryTier: payload.matchedDeliveryTier,
